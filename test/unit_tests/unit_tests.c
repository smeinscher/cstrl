...
#include "cstrl_util/test_priority_queue.h"
// #include "cstrl_util/test_random.h"

// void vec2_tests()
// {
//     int test_suite = test_manager_add_suite("vec2 Tests", "Suite for testing vec2 functions");
//     test_manager_add_test(test_suite, test_cstrl_vec2_length, "vec2 Length Test", "Test if correct length is
//     returned"); test_manager_add_test(test_suite, test_cstrl_vec2_normalize, "vec2 Normalize Test",
//                           "Test if correctly normalized vector is returned");
//     test_manager_add_test(test_suite, test_cstrl_vec2_add, "vec2 Add Test", "Test if correctly adds vector to
//     vector"); test_manager_add_test(test_suite, test_cstrl_vec2_sub, "vec2 Subtract Test", "Test if correctly
//     subtracts vectors"); test_manager_add_test(test_suite, test_cstrl_vec2_mult_scalar, "vec2 Multiply (Scalar)
//     Test",
...
//     test_manager_add_test(test_suite, test_cstrl_vec2_div, "vec2 Divide Test", "Test if correctly multiplies
//     vectors"); test_manager_add_test(test_suite, test_cstrl_vec2_dot, "vec2 Dot Product Test",
...
//     test_manager_add_test(test_suite, test_cstrl_vec3_length, "vec3 Length Test", "Test if correct length is
//     returned"); test_manager_add_test(test_suite, test_cstrl_vec3_normalize, "vec3 Normalize Test",
//                           "Test if correctly normalized vector is returned");
//     test_manager_add_test(test_suite, test_cstrl_vec3_add, "vec3 Add Test", "Test if correctly adds vector to
//     vector"); test_manager_add_test(test_suite, test_cstrl_vec3_sub, "vec3 Subtract Test", "Test if correctly
//     subtracts vectors"); test_manager_add_test(test_suite, test_cstrl_vec3_mul_scalar, "vec3 Multiply (Scalar) Test",
//                           "Test if correctly multiplies vector by scalar");
...
//     test_manager_add_test(test_suite, test_cstrl_vec4_length, "vec4 Length Test", "Test if correct length is
//     returned"); test_manager_add_test(test_suite, test_cstrl_vec4_normalize, "vec4 Normalize Test",
//                           "Test if correct normalized vector is returned");
//     test_manager_add_test(test_suite, test_cstrl_vec4_add, "vec4 Add Test", "Test if correctly adds vector to
//     vector"); test_manager_add_test(test_suite, test_cstrl_vec4_sub, "vec4 Subtract Test", "Test if correctly
//     subtracts vectors"); test_manager_add_test(test_suite, test_cstrl_vec4_mult_scalar, "vec4 Multiply (Scalar)
//     Test",
...
{
    int test_suite = test_manager_add_suite("Priority Queue Test", "Suite for testing priority queue functions");
    test_manager_add_test(test_suite, test_cstrl_pq_generic, "Generic Priority Queue",
                          "Test the generic functionality of priority queue");
    test_manager_run_tests(test_suite);
    test_manager_log_results(test_suite);
}
